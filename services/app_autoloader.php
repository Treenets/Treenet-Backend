...
$mapping = [
    ...
    // app classes
    'API_Handler' => './services/api_handler.php',
    'App_Response' => './services/app_response.php',
    'JWT' => './services/app_jwt.php',

    // database classes
    'Data_Access' => './services/db_classes/data_access.php',
    'App_API_Key' => './services/db_classes/app_api_key.php'
